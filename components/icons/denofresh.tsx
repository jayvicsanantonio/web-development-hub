...
export default function DenofreshIcon({
  width = 24,
  height = 24,
}: ComponentProps<"svg">) {
  return (
    <svg
      ...
      id="lemon-top"
    >
      <circle cx="18" cy="-100" r="4" fill="#fff"></circle>
      <path
      ...
      ></path>
      <path
        d="M18 64.86895039472425 C15 64.86895039472425 16 64.86895039472425 12 61L9 56C2 33 62 -3 80 12C103 27 44 56 29 58C27 58 25 59 24 61C20 64.86895039472425 21 64.86895039472425 18 64.86895039472425Z"
        fill="#fff"
      ></path>
      <path
