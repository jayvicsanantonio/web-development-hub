...
export default function AdobeExpressIcon({
  width = 24,
  height = 24,
}: ComponentProps<"svg">) {
  return (
        ...
        <g clipPath="url(#clippath-1)">
          ...
          <g clipPath="url(#clippath-2)">
            ...
            <image
              width="80"
              height="81"
              transform="translate(8.64 6.48) scale(.48)"
