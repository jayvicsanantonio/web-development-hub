// The filter toggle beside the search box. It only opens and closes the
// panel; the one panel is rendered by VerticalNavigation, since this button
// appears in both the desktop header and the mobile bar.
'use client';
