  ...
  return (
    <nav className="fixed left-0 top-0 z-40 flex h-full w-20 flex-col items-center overflow-y-auto bg-surface py-4 shadow-md3-elevation-1 dark:bg-neutral-800">
      ...
      <div className="mb-6 flex flex-col items-center text-center">
        <Link href="/" className="flex flex-col items-center text-primary dark:text-blue-400">
          <MountainIcon className="h-8 w-8" />
          <span className="mt-1 text-xs font-medium text-on-surface dark:text-neutral-300">Web Dev Hub</span>
        </Link>
      </div>
