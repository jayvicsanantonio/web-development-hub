export const SECTIONS = [
  {
    ...
    links: [
      ...
      },
      {
        ...
        description:
          'Modern web application development with JavaScript focusing on React, Redux, Node.js, MongoDB, and GraphQL.',
        tags: [
          'advanced',
          'course',
          'free',
  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        description:
          'AI-powered creative tool for generating images, text effects, and creative assets with Adobe Creative Cloud integration.',
        tags: [
          'ai',
          'design',
          'free',
      ...
      },
      {
        ...
        tags: ['advanced', 'ai', 'modern', 'paid', 'platform'],
      },
      {
      ...
      },
      {
        ...
        description:
          'Fast formatter, linter, and more for JavaScript, TypeScript, JSON, and CSS with zero configuration.',
        tags: [
          'advanced',
          'free',
          'javascript',
      ...
      },
      {
        ...
        tags: ['community', 'deployment', 'free', 'paid', 'platform'],
      },
      {
        title: 'ChatGPT',
      ...
      },
      {
        ...
        tags: ['ai', 'free', 'modern', 'paid', 'tool', 'trending'],
      },
      {
        title: 'Datadog',
      ...
      },
      {
        ...
        description:
          "Google's mobile and web app development platform with authentication, database, hosting, and analytics services.",
        tags: [
          'advanced',
          'authentication',
          'database',
      ...
      },
      {
        ...
        description:
          'Visual CMS and static site generator with markdown support, Git-based workflow, and modern development experience.',
        tags: [
          'beginner-friendly',
          'cms',
          'free',
      ...
      },
      {
        ...
        description:
          'Complete DevOps platform with Git repository management, CI/CD pipelines, and integrated development tools.',
        tags: [
          'advanced',
          'community',
          'deployment',
      ...
      },
      {
        ...
        tags: ['ai', 'modern', 'paid', 'tool', 'trending'],
      },
      {
        title: 'Glitch',
      ...
      },
      {
        ...
        tags: ['advanced', 'api', 'paid', 'platform', 'trending'],
      },
      {
        title: 'Supermaven',
      ...
      },
      {
        ...
        description:
          'High-quality stock photography platform with free images for web development, design, and creative projects.',
        tags: [
          'beginner-friendly',
          'design',
          'free',
...

  {
    ...
    links: [
      ...
      },
      {
        ...
        tags: ['advanced', 'community', 'free', 'trending'],
      },
      {
        title: 'Product Hunt',
  ...
  },
  {
    ...
    links: [
      ...
      },
      {
        ...
        tags: ['advanced', 'blog', 'free', 'javascript', 'tutorial'],
      },
      {
        title: 'Eric Elliott',
      ...
      },
      {
        ...
        tags: ['advanced', 'blog', 'free', 'modern', 'performance'],
      },
      {
        title: 'Jen Simmons',
