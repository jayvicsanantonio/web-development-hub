...
// Derived from SECTIONS so it can never drift from the catalogue. The previous
// hand-maintained copy of this mapping had already lost one entry.
const SECTION_BY_RESOURCE_TITLE = new Map<string, string>(
...
export function determineSection(title: string): string {
  return SECTION_BY_RESOURCE_TITLE.get(title) ?? 'Other';
}
